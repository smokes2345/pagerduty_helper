...
if __name__ == "__main__":
	...
	args.add_argument('-a','--ack',action='store_true',help="Acknowledge all incidents",default=False)
	...
	args.add_argument('--snooze-all',action='store_true',help="Snooze all incidents",default=False)
	sys.argv.pop(0)
	...
	for SERVICE in opts.services.split(','):
			...
			incidents = helper.get_incidents(payload=payload)
